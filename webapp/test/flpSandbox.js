		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comkaykyproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkaykyproject1-display": {
								"semanticObject": "comkaykyproject1",
								"action": "display",
								"description": "A application to show everything about crypto",
								"title": "Crypto Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kayky.project1",
									"url": sap.ui.require.toUrl("com/kayky/project1")
								}
							}
						}
					}
